function [querydata,querylabel,traindata,trainlabel,m_divergence]...
...
%     KL = temp_KLK;
    ...
    switch method
        case 'KL'
            [m_divergence, Msubscript] = max(KL);    
        case 'VE'
            [m_divergence, Msubscript] = max(VE);     
        case 'JS'
            [m_divergence, Msubscript] = max(JS);  
    end
